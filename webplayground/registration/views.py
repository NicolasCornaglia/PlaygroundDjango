...
from .forms import UserCreationFormWithEmail, ProfileFrom, EmailForm
...
class SignUpView(CreateView):
    ...
    def get_form(self, form_class=None):
        ...
        # Modificamos la visualizacion del formulario
...
class ProfileUpdate(UpdateView):
    ...
    def get_object(self):
        # recupera el objeto que editaremos
...
class EmailUpdate(UpdateView):
    ...
    def get_form(self, form_class = None):
        ...
        # Modifica en tiempo de ejecucion
